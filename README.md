...
2. **Set up the environment:**
   ...
   uv sync
   ```
   *(Alternatively, you can just install via pip: `pip install langchain langchain-openai python-dotenv yfinance langgraph`)*
...
uv run main.py
```
*(Or `python main.py` if using a traditional virtual environment).*

Once running, simply type your queries:
> **You:** "Give me the summary of AAPL"  
> **StockSensei:** *Responds with beautifully formatted market cap, P/E ratio, and 52-week data.*
